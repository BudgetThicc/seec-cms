...
const vipList=[
  {key:10,username:"ming",name:'ming',monetary:200},
  {key:12,username:"zxs",name:'zss',monetary:500}
  ...
  render(){
    ...
    return (
      ...
      <div>
        ...
        <Input ref="mo" onChange={(e)=>{monetary=e.target.value}} style={{width:"60%"}}></Input>
      </div>
      <div>
          <span>&emsp;</span>
        </div>
...
@inject('stepFormStore') @observer
class GiveCoupons extends BaseComponent {
  constructor(props){
    super(props)
    this.state={
      coupon:-1,
